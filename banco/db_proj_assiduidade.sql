...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Nov-2017 às 23:30
...
CREATE TABLE `aluno` (
  ...
  `aluno_id_pessoa` int(11) NOT NULL
...
CREATE TABLE `aluno_projeto` (
  `aluno_projeto_id_projeto` int(10) NOT NULL,
  `aluno_projeto_id_pessoa` int(10) NOT NULL,
  `vinculo` int(1) NOT NULL,
  `horas` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `cidade` (
  ...
  `cidade_id_estado` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cidade` (`id`, `nome`, `cidade_id_estado`) VALUES
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
(5, 'Capixaba', 1),
(6, 'Cruzeiro do Sul', 1),
...
CREATE TABLE `coordenador` (
  ...
  `coordenador_id_pessoa` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `curso_aluno` (
  `curso_aluno_id_curso` int(10) NOT NULL,
  `curso_aluno_id_pessoa` int(10) NOT NULL,
...
CREATE TABLE `observacoes` (
  `id` int(10) NOT NULL,
  `obs` text NOT NULL,
  `hr_realizadas` time NOT NULL,
  `dt` date NOT NULL,
  `hr_inicio` time NOT NULL,
  `hr_fim` time NOT NULL,
  `observacoes_ano_situacao_atual` int(10) NOT NULL,
  `observacoes_mes_situacao_atual` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pessoa` (
  `id` int(10) NOT NULL,
  `nivel_de_acesso` tinyint(11) NOT NULL,
...
INSERT INTO `pessoa` (`id`, `nivel_de_acesso`, `email`, `senha`, `nome`, `dt_nasc`, `cpf`, `login`, `sexo`, `nome_mae`, `telefone`, `endereco`, `cidade`) VALUES
(1, 2, 'f', 'g', 'f', '2017-11-02', '4', 'f', 'F', 'g', 'g', 'h', 6406),
(2, 2, 'f', 'g', 'f', '2017-11-02', '4', 'f', 'F', 'g', 'g', 'h', 6406),
(3, 1, 'ee', 'e', 'e', '2017-11-02', 'f', 'e', 'F', 'f', 's', 'f', 4603);
...
CREATE TABLE `projeto` (
  `id` int(10) NOT NULL,
  `sig_nr` int(20) NOT NULL,
  `tipo` int(1) NOT NULL,
  `dt_inicio` date NOT NULL,
  `titulo` varchar(30) NOT NULL,
  `dt_fim` date NOT NULL,
  `projeto_id_pessoa` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `servidor` (
  ...
  `servidor_id_pessoa` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `situacao_atual`
--
...
CREATE TABLE `situacao_atual` (
  ...
  `parecer_orientador` text NOT NULL,
  `parecer_coordenador` text NOT NULL,
  `situacao_atual_id_pessoa` int(10) NOT NULL,
  `situacao_atual_id_projeto` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `aluno`
  ...
  ADD KEY `aluno_id_pessoa` (`aluno_id_pessoa`);

--
-- Indexes for table `aluno_projeto`
--
ALTER TABLE `aluno_projeto`
  ADD PRIMARY KEY (`aluno_projeto_id_projeto`,`aluno_projeto_id_pessoa`),
  ADD KEY `aluno_projeto_id_pessoa` (`aluno_projeto_id_pessoa`);
...
ALTER TABLE `cidade`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cidade_id_estado` (`cidade_id_estado`);

--
-- Indexes for table `coordenador`
--
ALTER TABLE `coordenador`
  ADD PRIMARY KEY (`coordenador_id_pessoa`);
...
ALTER TABLE `curso_aluno`
  ADD PRIMARY KEY (`curso_aluno_id_curso`,`curso_aluno_id_pessoa`),
  ADD KEY `curso_aluno_id_pessoa` (`curso_aluno_id_pessoa`);
...
ALTER TABLE `observacoes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `observacoes_mes_situacao_atual` (`observacoes_ano_situacao_atual`,`observacoes_mes_situacao_atual`);
...
ALTER TABLE `projeto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `projeto_id_pessoa` (`projeto_id_pessoa`);

--
-- Indexes for table `servidor`
--
ALTER TABLE `servidor`
  ADD PRIMARY KEY (`servidor_id_pessoa`);

--
-- Indexes for table `situacao_atual`
--
ALTER TABLE `situacao_atual`
  ADD PRIMARY KEY (`ano`,`mes`),
  ADD KEY `situacao_atual_id_pessoa` (`situacao_atual_id_pessoa`),
  ADD KEY `situacao_atual_id_projeto` (`situacao_atual_id_projeto`);
...
--
ALTER TABLE `aluno`
  ADD CONSTRAINT `aluno_ibfk_1` FOREIGN KEY (`aluno_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `aluno_projeto`
--
ALTER TABLE `aluno_projeto`
  ADD CONSTRAINT `aluno_projeto_ibfk_1` FOREIGN KEY (`aluno_projeto_id_projeto`) REFERENCES `projeto` (`id`),
  ADD CONSTRAINT `aluno_projeto_ibfk_2` FOREIGN KEY (`aluno_projeto_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `cidade`
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `cidade_ibfk_1` FOREIGN KEY (`cidade_id_estado`) REFERENCES `estado` (`id`);

--
-- Limitadores para a tabela `coordenador`
--
ALTER TABLE `coordenador`
  ADD CONSTRAINT `coordenador_ibfk_1` FOREIGN KEY (`coordenador_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `curso_aluno`
--
ALTER TABLE `curso_aluno`
  ADD CONSTRAINT `curso_aluno_ibfk_1` FOREIGN KEY (`curso_aluno_id_curso`) REFERENCES `curso` (`id`),
  ADD CONSTRAINT `curso_aluno_ibfk_2` FOREIGN KEY (`curso_aluno_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `pessoa`
--
ALTER TABLE `pessoa`
  ADD CONSTRAINT `pessoa_ibfk_1` FOREIGN KEY (`cidade`) REFERENCES `cidade` (`id`);

--
-- Limitadores para a tabela `projeto`
--
ALTER TABLE `projeto`
  ADD CONSTRAINT `projeto_ibfk_1` FOREIGN KEY (`projeto_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `servidor`
--
ALTER TABLE `servidor`
  ADD CONSTRAINT `servidor_ibfk_1` FOREIGN KEY (`servidor_id_pessoa`) REFERENCES `pessoa` (`id`);

--
-- Limitadores para a tabela `situacao_atual`
--
ALTER TABLE `situacao_atual`
  ADD CONSTRAINT `situacao_atual_ibfk_1` FOREIGN KEY (`situacao_atual_id_pessoa`) REFERENCES `pessoa` (`id`),
  ADD CONSTRAINT `situacao_atual_ibfk_2` FOREIGN KEY (`situacao_atual_id_projeto`) REFERENCES `projeto` (`id`);
